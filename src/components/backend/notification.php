...
$query = "SELECT a.id, a.action, a.task, a.job_code, a.member, a.action_date, a.notification_id, a.users_id FROM (SELECT DISTINCT Actions.id, Actions.action, Actions.task, Actions.job_code, Actions.member, Actions.action_date, notification_info.notification_id, notification_info.users_id FROM Actions INNER JOIN UserDocumentAuthorization ON 
