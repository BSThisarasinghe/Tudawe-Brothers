...
$arr = array();
$sql = "SELECT DISTINCT JobMaster.Job_Code, JobMaster.Job_Name FROM (((UserSRNJobPermission INNER JOIN JobMaster "
        ...
        . "and TLReject!=1 and SLReject!=1 and FLReject!=1 AND ((SiteRequisitionMaster.SLevel = 0 AND "
        . "UserDocumentAuthorization.FirstLevel = '" . $userlevel . "') OR (SiteRequisitionMaster.FLevel != 0"
        . " AND SiteRequisitionMaster.TLevel = 0 AND UserDocumentAuthorization.SecondLevel = '" . $userlevel . "')"
        . " OR (SiteRequisitionMaster.SLevel != 0 AND SiteRequisitionMaster.FourthLevel = 0 AND "
        . "UserDocumentAuthorization.ThirdLevel = '" . $userlevel . "') OR (SiteRequisitionMaster.TLevel != 0 "
        . "AND UserDocumentAuthorization.FourthLevel = '" . $userlevel . "'))";
if ($job_level != NULL) {
    if ($job_level == '1st Level') {
        $sql = "SELECT DISTINCT JobMaster.Job_Code, JobMaster.Job_Name FROM (((UserSRNJobPermission INNER JOIN "
                ...
                . "SiteRequisitionMaster.SLevel = 0 AND UserDocumentAuthorization.FirstLevel = '" . $userlevel . "'";
        ...
        $sql = "SELECT DISTINCT JobMaster.Job_Code, JobMaster.Job_Name FROM (((UserSRNJobPermission INNER JOIN "
                ...
                . " UserDocumentAuthorization ON JobMaster.Job_Code = UserDocumentAuthorization.JobCode) WHERE"
                . " SiteRequisitionMaster.Cancelied!=1 and TLReject!=1 and SLReject!=1 and FLReject!=1 AND "
                . "SiteRequisitionMaster.FLevel != 0 AND SiteRequisitionMaster.TLevel = 0 AND "
        ...
        $sql = "SELECT DISTINCT JobMaster.Job_Code, JobMaster.Job_Name FROM (((UserSRNJobPermission INNER JOIN"
                ...
                . "UserDocumentAuthorization ON JobMaster.Job_Code = UserDocumentAuthorization.JobCode) WHERE "
                . "SiteRequisitionMaster.Cancelied!=1 and TLReject!=1 and SLReject!=1 and FLReject!=1 AND "
                . "SiteRequisitionMaster.SLevel != 0 AND SiteRequisitionMaster.FourthLevel = 0 AND "
        ...
        $sql = "SELECT DISTINCT JobMaster.Job_Code, JobMaster.Job_Name FROM (((UserSRNJobPermission INNER JOIN "
                ...
                . "UserDocumentAuthorization ON JobMaster.Job_Code = UserDocumentAuthorization.JobCode) WHERE "
                . "SiteRequisitionMaster.Cancelied!=1 and TLReject!=1 and SLReject!=1 and FLReject!=1 AND "
                . "SiteRequisitionMaster.TLevel != 0 AND UserDocumentAuthorization.FourthLevel = '" . $userlevel . "'";
    }
}
