...
$arr = array();
$sql = "SELECT DISTINCT TOP 100 JobMaster.Job_Code, JobMaster.Job_Name FROM (((UserSRNJobPermission INNER JOIN JobMaster ON UserSRNJobPermission.AccountCode = "
...
if ($job_level != NULL) {
    if ($job_level == '1st Level') {
        ...
        $sql = "SELECT DISTINCT TOP 100 JobMaster.Job_Code, JobMaster.Job_Name FROM (((UserSRNJobPermission INNER JOIN JobMaster ON "
